...
def parse_args():
    ...
    parser.add_argument('--alpha', type=float, default=0.0, help='constrast loss.')
    parser.add_argument('--vv_num', type=int, default=20, help='')
    parser.add_argument('--c_num', type=int, default=50, help='')
